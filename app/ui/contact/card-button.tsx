...
export default function CardButton({ title, description, href, icon }: { title: string, description: string, href: string, icon: React.ReactNode }) {
  ...
  return (
    <Link href={href} className="min-h-[150px] flex-1 p-4 flex flex-col md:flex-row gap-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
      <div className="flex justify-center rounded-t-lg md:rounded-none md:rounded-s-lg">
        {icon}
      </div>
      <div className="leading-normal text-center md:text-justify">
