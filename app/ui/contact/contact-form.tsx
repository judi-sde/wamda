  ...
  return (
    <div className={className ? "" : "px-4 -mt-16"}>
      <form action="#" className={className || "lg:hidden space-y-8 p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800 relative z-10"}>
        <div className="lg:gap-4 gap-8 flex flex-row lg:flex-row">
          <div>
            <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{form["name"].label}</label>
            <input type="text" id="name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder={form["name"].placeholder} required />
          </div>
          <div>
            <label htmlFor="contact-info" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{form["phone"].label}</label>
            <input type="text" id="contact-info" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder={form["phone"].placeholder} required />
          </div>
        </div>
        <div>
          <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{form["email"]}</label>
        ...
        <div className="sm:col-span-2">
          ...
          <textarea id="message" rows={className ? 3 : 4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={form["message"].placeholder}></textarea>
        </div>
